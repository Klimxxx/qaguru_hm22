...
from android_wikipedia_tests import utils
...
bstack_userName = os.getenv('bstack_userName', 'klim_0YKy6j')
bstack_accessKey = os.getenv('bstack_accessKey', 'ijczddUv81x2mjaeqgj8')
